...
void CMFCApplication2Dlg::OnBnClickedButton1()
{
	...
	m_edit1.SetWindowTextW(str + "추가된 문장입니다");
}
...
{
	// TODO: 여기에 컨트롤 알림 처리기 코드를 추가합니다.
	//MessageBox(L"MFC test", L"MFC TEST1");
	m_edit1.SetWindowTextW(L"2번");
}
